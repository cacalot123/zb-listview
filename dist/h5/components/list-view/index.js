...
class ListView extends Component {
  ...
  render() {
    ...
    return <Skeleton isLoaded={isLoaded || isError} selector={selector}>
      ...
      }} className={`${className} scroll-view`} style={newStyle} onTouchMove={() => { return true }} scrollY={canScrollY} lowerThreshold={600} onScrollToLower={this.handleScrollToLower} scrollWithAnimation onScroll={this.onScroll}>
